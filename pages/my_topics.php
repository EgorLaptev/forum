...
<head>
  ...
  <link rel="stylesheet" href="../media/css/my_topics.css">
  <title>Forum</title>
</head>
  ...
  <main class="main-content">
    <ul class="my_topics">
      <?php
        ...
        $topics = $pdo->query("SELECT * FROM `topics` WHERE `author` = '$author'")
      ...
      ?>
        <li class="topic">
          <button id="delete_topic" class="topic-delete" data-id="<?=$topic['id']?>">Delete</button>
